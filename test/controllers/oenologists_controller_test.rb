...
class OenologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist" do
    assert_difference('Oenologist.count') do
      post oenologists_url, params: { oenologist: { Age: @oenologist.Age, Country: @oenologist.Country, Name: @oenologist.Name } }
    end
  ...
  test "should update oenologist" do
    patch oenologist_url(@oenologist), params: { oenologist: { Age: @oenologist.Age, Country: @oenologist.Country, Name: @oenologist.Name } }
